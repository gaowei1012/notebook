...
const List<Doodle> doodles = [
  Doodle(
      ...
      doodle:
          "https://gaomingwei.xyz/wp-content/uploads/2019/07/google_one.jpg",
  ...
  Doodle(
      ...
      doodle:
          "https://gaomingwei.xyz/wp-content/uploads/2019/07/unnamed.jpg",
      icon: Icon(
        Icons.exposure,
        color: Colors.white,
      ),
  ...
  Doodle(
      ...
      doodle:
          "https://gaomingwei.xyz/wp-content/uploads/2019/07/ibn-sinas-1038th-birthday-5768556863029248.2-2x.png",
      icon: Icon(
        Icons.healing,
        color: Colors.white,
      ),
  ...
  Doodle(
      ...
      doodle:
          "https://gaomingwei.xyz/wp-content/uploads/2019/07/unnamed2.jpg",
      icon: Icon(
        Icons.blur_circular,
        color: Colors.white,
      ),
